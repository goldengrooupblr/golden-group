  ...
  return (
    <section className="border-y border-[#464646] bg-black text-white">
      <div className="grid grid-cols-1 md:grid-cols-[30%_70%]">
        <div className="relative flex min-h-[269px] items-end p-[30px] md:min-h-[665px] md:justify-end">
          <Reveal>
        ...
        <div className="relative flex flex-col gap-[17px] p-[30px] md:border-l md:border-[#464646] md:py-[60px]">
